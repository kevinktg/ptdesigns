    ...
    return (
        < div ref={fbConRef} className="w-screen h-dvh p-2 overflow-hidden" >
            <div className='w-full relative overflow-hidden rounded-4xl'>
                ...
                <h1 className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[10vw] font-bold text-[#f4f4f4]'><span className="brand-name">Parm Tjhung</span><span className="brand-designs">DESIGNS</span></h1>
                <div className='absolute bottom-5 px-4 w-full'>
                    <div className="w-full h-auto flex md:flex-row flex-col md:justify-between md:items-end">
                        <h2
                            className="text-start lg:mt-0 md:text-[#f4f4f4] text-[#BFA77A] text-2xl font-bold md:tracking-wider leading-5 flex flex-col gap-1"
                            style={{ textShadow: '2px 2px 4px #000' }}
                        >
                            <span>Start Your</span>
                            <span>Project—Start</span>
                            <span>With Parm Tjhung Designs</span>
                        </h2>

                        <p
                            className="md:w-[20%] w-[80%] text-[#f4f4f4] text-[0.69rem] font-bold  md:font-medium tracking-wide lg:text-end mt-2 text-justify"
                            style={{ textShadow: '2px 2px 4px #000' }}
                        >
                            Start your project with Parm Tjhung Designs — Perth's luxury architecture practice.
                        </p>
                    </div>
                </div>
            </div>
